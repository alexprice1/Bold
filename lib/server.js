...
exports.server = function() {
  ...
  if (typeof arguments[0] == 'object') {
    ...
    //remove in the future. This prevents forcing config object to have apiLocation
    if(!config.api){
      config.api={};
    }
    config.api.location=apiLocation = config.api.location ? config.api.location : config.apiLocation;
